(() => {
    ...
    function scrollFunction() {
        if (document.body.scrollTop > 80 || document.documentElement.scrollTop > 80) document.querySelector(".header__menu").style.top = "20px"; else document.querySelector(".header__menu").style.top = "50px";
    }
    (function() {
    ...
    const script_elements = document.querySelectorAll("[data-package-title]");
